...
class ProductImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_image" do
    assert_difference("ProductImage.count") do
      post product_images_url, params: { product_image: { Product_id: @product_image.Product_id, image: @product_image.image } }
    end
  ...
  test "should update product_image" do
    patch product_image_url(@product_image), params: { product_image: { Product_id: @product_image.Product_id, image: @product_image.image } }
