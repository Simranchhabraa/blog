...
ActiveRecord::Schema[7.0].define(version: 2023_03_25_115503) do
  ...
  create_table "whishlists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["merchant_id"], name: "index_whishlists_on_merchant_id"
  ...
  add_foreign_key "whishlists", "merchants"
